...
public class LonelyPhoto {
    public static void main(String[] args) throws IOException {
        for (int r = 1; r < 12; r++) {
            ...
            Scanner scanner = new Scanner(new File("src/USACO/Bronze/_21_22/Dec/prob1_bronze_dec21/" + r + ".in"));
            ...
            Scanner check = new Scanner(new File("src/USACO/Bronze/_21_22/Dec/prob1_bronze_dec21/" + r + ".out"));
